...
exports.default = function () {
  ...
  if (isDirectory) {
    (0, _assert2.default)(!directoryExists((0, _path.join)(cwd, "src", "pages", file)), "directory src/page/" + file + " exists");
    jsTargetPath = (0, _path.join)(cwd, "src", "pages", file, "page.js");
    lessTargetPath = (0, _path.join)(cwd, "src", "pages", file, "page.less");
  ...
  (0, _assert2.default)(!fileExists(jsTargetPath), "file src/page/" + file + " exists");
  (0, _assert2.default)(!fileExists(modelTargetPath), "file src/page/" + file + " exists");
  (0, _assert2.default)(!fileExists(lessTargetPath), "file src/page/" + file + " exists");
  (0, _assert2.default)(!fileExists(serviceTargetPath), "file src/page/" + file + " exists");
  (0, _assert2.default)(!fileExists(cjsTargetPath), "file src/page/" + file + " exists");
  (0, _assert2.default)(!fileExists(clessTargetPath), "file src/page/" + file + " exists");

  var jsTpl = (0, _fs.readFileSync)((0, _path.join)(__dirname, "../../template/example/page.js"), "utf-8");
  var cssTpl = (0, _fs.readFileSync)((0, _path.join)(__dirname, "../../template/example/page.less"), "utf-8");
